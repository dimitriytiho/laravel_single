...
Route::namespace(config('add.namespace_controllers') . '\\Shop')->group(function () {
    ...
    // Cart
    Route::post('cart/promo', 'CartController@promo')->name('promo_post');
    Route::post('cart/delivery', 'CartController@delivery')->name('delivery_post');
    ...
    Route::post('order/promo', 'OrderController@promo')->name('promo_post');
    Route::post('order/delivery', 'OrderController@delivery')->name('delivery_post');
