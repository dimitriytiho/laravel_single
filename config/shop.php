...
return [
    ...
    */
    ...
    // Виды акций
    'promo_type' => [
        'all_products', // В корзине все товары из акции. Первое значение по-умолчанию.
        'one_product', // Хотя бы один товар из акции
        'product_as_gift', // Товар в подарок, если сумма чека соответстует цене акции
        'two_plus_one', // Если покупают 2 товара, то 3-ий в подарок
    ],


    'discount_max' => 30, // Максимальная скидка для корзины
